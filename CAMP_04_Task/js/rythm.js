// 拾ってきたよ！Vol.2
// ふはははは。動かず！テンプレ系は、よくわからず…。
// https://okazari.github.io/Rythm.js/


// オリジナル⇒<script type="text/javascript" src="/path/to/rythm.min.js"></script>
// こちらを張ると、リンクエラー（net::ERR_ABORTED 404 (Not Found)）が出たため、ギットハブから、ソースを引っ張ってきてフォルダーに設置してみる。
// ここが違いそう。XAMPP内/ローカルファイルではなく、ネットワーク上にあれば動くのかな？？
